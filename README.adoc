...
It contains liquibase meta model.
...
https://github.com/BlackBeltTechnology/judo-meta-liquibase/releases
...
https://app.wercker.com/BlackbeltTechnology/judo-meta-liquibase/runs
